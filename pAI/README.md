...
### GitHub Releases
Download the latest APK or AAB from the [Releases](https://github.com/YOUR_USERNAME/pAI/releases) page.
...
1. **Clone the repository**
   ```bash
   git clone https://github.com/YOUR_USERNAME/pAI.git
   cd pAI
   ```
...
- Open an [Issue](https://github.com/YOUR_USERNAME/pAI/issues)
- Check the [Discussions](https://github.com/YOUR_USERNAME/pAI/discussions) tab
